...
//    MaskFormatter mascaraData;
    ...
    public JDlgProdutoNovoIABjf(java.awt.Frame parent, boolean modal) {
     ...
     public ProdutoBjf viewBean() {
        ...
        Double salario = Util.strDouble(jFmtPreco_Bjf.getText());
        
        produtoBjf.setIdprodutoBjf(id);
        produtoBjf.setNomeBjf(JTxtNome_Bjf.getText());
        produtoBjf.setDescricaoBjf(JTxtDescricao_Bjf.getText());
        produtoBjf.setPrecoBjf(salario);
//        Double salario = Util.strDouble(jFmtPreco_Bjf.getText());
...
//        produtoBjf.setQuantidadeBjf(jFmtQuantidade_Bjf.getText());
    ...
    public void beanView(ProdutoBjf produtoBjf) {
        ...
        String intStr = Util.intStr(produtoBjf.getIdprodutoBjf());
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(jFmtCodigo, javax.swing.GroupLayout.PREFERRED_SIZE, 241, javax.swing.GroupLayout.PREFERRED_SIZE)))
