...
import view.JDlgUsuariosBjf;

/**
 *
 * @author duals
 */
public class JDlgUsuariosPesquisaBjf extends javax.swing.JDialog {

    private JDlgUsuariosBjf jDlgUsuariosBjf;
    private UsuariosControleBjf usuariosControleBjf = new UsuariosControleBjf();

    /**
     * Creates new form JDlgUsuariosPesquisaBjf
     */
    public JDlgUsuariosPesquisaBjf(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Pesquisa de Usuarios");
    ...
    private void jBtnOkBjfActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnOkBjfActionPerformed
        ...
        UsuariosBjf usuariosBjf = usuariosControleBjf.getBean(rowSel);
        jDlgUsuariosBjf.beanView(usuariosBjf);
        JDlgUsuariosPesquisaBjf.this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDlgUsuariosPesquisaBjf.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDlgUsuariosPesquisaBjf dialog = new JDlgUsuariosPesquisaBjf(new javax.swing.JFrame(), true);
